...
function LikedProduct(){
    ...
    useEffect(()=>{
        const url ='https://bit-kart-1.onrender.com/liked-product';
    ...
    const HandleLike =(productId)=>{
        ...
        const url ='https://bit-kart-1.onrender.com/like-product';
        axios.post(url,data)
        .then((res)=>{
              if(res.data.message){
                alert("liked");
                ...
                {cproducts && cproducts.length>0  && cproducts.map((item, index)=>{
                    return(
                        ...
                        <div onClick={()=>handleProduct(item._id)} key={item._id}className="card">
                            ...
                            <img width="300px" height="300px" src={'https://bit-kart-1.onrender.com/'+item.Pimage} />
